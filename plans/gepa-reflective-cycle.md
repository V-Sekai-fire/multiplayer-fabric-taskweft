...
### 8. RECTGTN Planner Integration [9.2/10]

Bridge between goal-oriented planner and task-weaving runtime. Synchronizes hierarchical
strategic goals with tactical "weft" execution.
...
### 9. Streaming Output Parsing — Presence Optimizer [9.0/10]
...
### 10. ASI Serialization — Failure Memory [8.9/10]
...
### 11. GEPA — The Reflective Optimizer [8.8/10]
...
### 12. Program-of-Thought — Physics Bridge [8.8/10]
...
### 13. RLM — Recursive Language Model [8.7/10]
...
### 14. Blackboard Persistence — Long-Term Memory [8.5/10]
...
### 15. BootstrapFewShot — Experience Buffer [8.2/10]
...
### 16. Tool-Calling — Tool-Use Controller [7.8/10]

Iterative loop where the agent selects engine tools and observes results. High-level
"System 2" control of game subsystems (Navigation, Inventory, Combat).
...
### 17. Assertions & Suggestions — Runtime Guardrails [7.5/10]
...
| `schick2023toolformer` | Verified — arXiv:2302.04761 (Meta AI) |
...
| `roma2025openmeta`, `roma2025planner`, `roma2025scheduling` | Internal/pre-publication |
